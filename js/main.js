    ...
    const projectsList = [
        {
            ...
            highlights: [
                ...
                'SOLID modular architecture components',
        ...
        },
        {
            ...
            companyUrl: 'http://saaei.co/',
            brief: 'Engineered the mobile application for Saudi Arabia’s premier PropTech platform. Integrated Nafath secure SSO identity verification, REGA compliance protocols, and secure sensitive data protection, while reducing ANR rate by 30%.',
            playStoreUrl: 'https://play.google.com/store/apps/details?id=com.saaei',
            highlights: [
                'Integrated Nafath SSO and REGA portals',
                'Improved app security using AES-256 encryption, SSL pinning, and NDK keys',
                'Reduced ANR rate by 30% via optimization',
                'Interactive map and negotiation chat engine'
            ],
            screenshots: [
        ...
        },
        {
            ...
            companyUrl: 'https://www.metrics-consultancy.com/',
            ...
            highlights: [
                ...
                'Progress tracking & construction reporting',
                'Offline persistence with Cloud Firestore'
            ],
            screenshots: [
        ...
        },
        {
            id: 'ekhtar',
            name: 'Ekhtar',
            logoUrl: 'https://lh3.googleusercontent.com/OLg-JLMIH0eQa0u6MSs1diqzRFZk9CCtsQBEgLy6N7nYPKRJmz4T3QQ-XIl0KdnrSg',
            downloads: '',
            rating: '',
            category: 'Logistics & On-Demand Delivery',
            company: 'Ekhtar Startup (Android Developer & Co-Founder)',
            companyUrl: 'https://www.facebook.com/EkhtarEgypt/',
            brief: 'Co-founded the startup and built the Java Android apps. Initially a local store directory, the app pivoted to delivery models (Wasally & Hatley) to test customer demand before operations ended.',
            highlights: [
                'Developed Wasally and Hatley Android clients using Java and Firebase Realtime Database',
                'Integrated Google Maps for real-time delivery tracking',
                'Built catalog search and cart flows using Algolia',
                'Implemented real-time order status notifications using FCM'
            ],
            screenshots: [
                'https://lh3.googleusercontent.com/urUzeElD3lhFTNuCUM8jZvWcliJ14o3aqhFyrJH_IDpfRAGcq1tc3uWEKoo0xKHY3w',
                'https://lh3.googleusercontent.com/0ynOE5rRQBU_5lw4yfXACEEmCBp2AYJj8yNOBPmD6qxkRz75WvcTaq07QcWnMzFCQHw',
                'https://lh3.googleusercontent.com/bR2fx6-su1Sz3NXU3P1P9c8w-6kI-WWZl9uHIEMkE6NZZs6Qob-xkMOeU_ARrl8gMQw'
            ]
        },
        {
            id: 'ekhtar_sellers',
            name: 'Ekhtar Sellers',
            logoUrl: 'https://lh3.googleusercontent.com/HbiB-98-1oPtvr81UPJIcoo3aJUgqVe5_Ut8EwMdLhvYPAYIv8drujsvRu-oG7nu-Js',
            downloads: '',
            rating: '',
            category: 'Merchant Portal & Management',
            company: 'Ekhtar Startup (Android Developer & Co-Founder)',
            companyUrl: 'https://www.facebook.com/EkhtarEgypt/',
            brief: 'Developed the merchant-facing Android application to help store owners monitor their stores, fulfill incoming orders, and manage their product listings and inventory.',
            highlights: [
                'Merchant order flows with FCM notifications',
                'Inventory updates for prices and quantities',
                'Product image uploads via Firebase Storage',
                'SendGrid integration for customer receipts'
            ],
            screenshots: [
                'https://lh3.googleusercontent.com/RT1HmBiG03XNQVKCmlY1M3cpKEuaK5A7k4FfrGXuU5AYcbzze9bNCZHR7_HYccKMpKU',
                'https://lh3.googleusercontent.com/hnEoN-plnq0FSWTlD4lW7R5QBhqD4u5V6FZRk2WL2RF-kHtUPdli0mQT5ccip1kY9A',
                'https://lh3.googleusercontent.com/4UbYlRi0tDLuPRk6QbgYu482hQkN6oGZ2DxE-LMCVzy3LheUWGfC1O_g2whZ67F17FY',
                'https://lh3.googleusercontent.com/DfEKBcFKleeAXH5mpGfcjpQsTqDNaN1gAZ4oJKe8XKQuZluXwghU_b-_77Xzb3HTjG0'
            ]
        },
        {
            id: 'ekhtar_pos',
            name: 'Ekhtar POS',
            logoUrl: 'https://lh3.googleusercontent.com/mpGNI-7lfpSABOkmmyXKj9s_YotYlyCFzt3-HrpQLWCMdQaCdg1bb0L0oWqBRNgWzA',
            downloads: '',
            rating: '',
            category: 'Point of Sale (POS)',
            company: 'Ekhtar Startup (Android Developer & Co-Founder)',
            companyUrl: 'https://www.facebook.com/EkhtarEgypt/',
            brief: 'Developed the Point of Sale (POS) Android application for merchants to register sales in-store, track inventory levels in real-time, and run basic customer loyalty profiles.',
            highlights: [
                'Checkout screens for in-store sales',
                'Customer CRM search profiles via Algolia',
                'Loyalty points tracking using Firestore',
                'Offline support using SQLite and Room'
            ],
            screenshots: [
                'https://lh3.googleusercontent.com/piyfq2IVMhVNc47cZSu-NVRfd6UW7WD5q9g1te3eTToY2UOeCj4xMeji8ENKaZCIGg',
                'https://lh3.googleusercontent.com/DeZ2I_5s3vh7G4suMCAXkbjD8O0versSD1j5W7-3pM3Kt7w9A6zUpMPrXX5OEzNtgcE'
            ]
        }
    ];
                ...
                <div class="app-details-header">
                    ...
                    <div>
                        ...
                        <div class="app-details-company">
                            ${app.companyUrl ? `<a href="${app.companyUrl}" target="_blank" rel="noopener" class="app-company-link">${app.company}</a>` : app.company}
                        </div>
                    </div>
                </div>
